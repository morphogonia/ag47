...
<form action="contacto_s.php" method="post" onsubmit="return validacion()">
<label for="nombre" id="labnom">Nombre:</label>
<input type="text" id="nombre" name="nombre" class="requerido" />
<br/>		
<label for="email" id="labema">E-mail:</label>
<input type="text" id="email" name="email" class="requerido" />
<br/>		
<label for="comentarios" id="labcom">Comentarios:</label>
...
<div id="contacto" class="floatl">
	<p>Adriana Gutiérrez</p>
	<p>Joyería Contemporánea</p>
	<p><a href="mailto:adriana@ag47joyeria.com" target="_blank">adriana@ag47joyeria.com</a></p>
	<p><a href="mailto:contacto@ag47joyeria.com" target="_blank">contacto@ag47joyeria.com</a></p>
	<p>T. 52 50 50 60</p>
</div>
