...
<div id="insertar">
<form enctype="multipart/form-data" action="categorias_n_s.php" method="post">
	<label>Nombre:</label>
	<input type="text" id="nombre" name="nombre" class="requerido"/><br/><br/>
	<label>Clasificado en:</label>
		
	<select name="cat">					
	<?			
	$resultado = @mysql_query('SELECT * FROM tb_categories');
